const migration_202505050001_seed_default_check_in_schedule = {
  ...
  up: function () {
    ...
    ensureRowsByKey_('CheckIn', 'Day', [
      { Day: 1, RewardCurrency: 'coins', RewardAmount: 100, BonusItemId: '', Notes: 'Day 1 — welcome.' },
      ...
      { Day: 5, RewardCurrency: 'tickets', RewardAmount: 1, BonusItemId: '', Notes: 'Tournament ticket.' },
      { Day: 6, RewardCurrency: 'coins', RewardAmount: 800, BonusItemId: '', Notes: '' },
      { Day: 7, RewardCurrency: 'gems', RewardAmount: 25, BonusItemId: 'avatar_starter', Notes: 'Bonus avatar on day 7.' },
    ]);
  },
};
