const migration_202505010001_initial_setup = {
  id: '202505010001_initial_setup',
  ...
  up: function () {
    ...
    ensureRowsByKey_('AdminConfigWritePermissions', 'ConfigKey', [
      {
        ConfigKey: 'AdminPermissions',
        MinWriteLevel: 3,
        Notes: 'Admin access changes — super-admin only.',
      },
      {
        ConfigKey: 'AdminConfigWritePermissions',
        MinWriteLevel: 3,
        Notes: 'Write-permission rules — super-admin only.',
      },
